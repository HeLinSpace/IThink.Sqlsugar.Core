...
namespace IThink.Sqlsugar.Core
{
    ...
    /// </summary>
    public class SqlSugarDbRepository : ISqlSugarDbRepository
    {
        ...
        public SqlSugarDbRepository(IEnumerable<BaseSqlSugarClient> clients)
        {
            _clients = clients;
        ...
        /// <returns></returns>
        public SqlSugarDbRepository UseDb(string dbName)
        {
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        public (int, List<TEntity>) GetPageList<TEntity>(PageQueryRequest page, Expression<Func<TEntity, bool>> whereExpression = null, Expression<Func<TEntity, object>> orderByExpression = null, OrderByType orderByType = OrderByType.Asc) where TEntity : BaseEntity, new()
        {
            int count = 0;
            var result = DbContext.Queryable<TEntity>().WhereIF(whereExpression != null, whereExpression).OrderByIF(orderByExpression != null, orderByExpression, orderByType).WithCacheIF(UseCache).ToPageList(page.PageNumber.Value, page.PageSize.Value, ref count);
            return (count, result);
        }
        ...
        {
            int count = 0;
            var result = DbContext.Queryable<TEntity>().WhereIF(whereExpression != null, whereExpression).OrderByIF(orderByExpression != null, orderByExpression, orderByType).Select(selectExpression).WithCacheIF(UseCache).ToPageList(page.PageNumber.Value, page.PageSize.Value, ref count);
            return (count, result);
        }
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        public async Task<(int, List<TEntity>)> GetPageListAsync<TEntity>(PageQueryRequest page, Expression<Func<TEntity, bool>> whereExpression = null, Expression<Func<TEntity, object>> orderByExpression = null, OrderByType orderByType = OrderByType.Asc) where TEntity : BaseEntity, new()
        {
            int count = 0;
            var result = await DbContext.Queryable<TEntity>().WhereIF(whereExpression != null, whereExpression).OrderByIF(orderByExpression != null, orderByExpression, orderByType).WithCacheIF(UseCache).ToPageListAsync(page.PageNumber.Value, page.PageSize.Value, count);
            return (count, result);
        }
