...
namespace IThink.Sqlsugar.Core
{
    ...
    /// 可配置缓存仓储对象
    /// </summary>
    public interface ISqlSugarDbRepository
    {
        //ISqlSugarDbCacheRepository UseDb(string dbName);
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        (int, List<TEntity>) GetPageList<TEntity>(PageQueryRequest page, Expression<Func<TEntity, bool>> whereExpression = null, Expression<Func<TEntity, object>> orderByExpression = null, OrderByType orderByType = OrderByType.Asc) where TEntity : BaseEntity, new();
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        Task<(int, List<TEntity>)> GetPageListAsync<TEntity>(PageQueryRequest page, Expression<Func<TEntity, bool>> whereExpression = null, Expression<Func<TEntity, object>> orderByExpression = null, OrderByType orderByType = OrderByType.Asc) where TEntity : BaseEntity, new();
